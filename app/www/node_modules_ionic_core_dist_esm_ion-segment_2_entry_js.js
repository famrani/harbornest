...
/* harmony import */ var _ionic_global_b26f573e_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ionic-global-b26f573e.js */ 23589);
...
const SegmentButton = class {
  ...
  connectedCallback() {
    ...
    if (segmentEl) {
      this.updateState();
      (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_2__.a)(segmentEl, 'ionSelect', this.updateState);
      (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_2__.a)(segmentEl, 'ionStyle', this.updateStyle);
    }
    // Prevent buttons from being disabled when associated with segment content
    if (this.contentId && this.disabled) {
      (0,_index_cfd9c1f2_js__WEBPACK_IMPORTED_MODULE_6__.p)(`[ion-segment-button] - Segment buttons cannot be disabled when associated with an <ion-segment-content>.`);
      this.disabled = false;
    }
  }
  disconnectedCallback() {
    ...
    if (segmentEl) {
      (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_2__.b)(segmentEl, 'ionSelect', this.updateState);
      (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_2__.b)(segmentEl, 'ionStyle', this.updateStyle);
      this.segmentEl = null;
    }
  }
  componentWillLoad() {
    this.inheritedAttributes = Object.assign({}, (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_2__.h)(this.el, ['aria-label']));
    ...
    if (!segmentContent) {
      (0,_index_cfd9c1f2_js__WEBPACK_IMPORTED_MODULE_6__.d)(`[ion-segment-button] - Unable to find Segment Content with id="${this.contentId}".`);
      return;
    }
    // Ensure the found element is a valid ION-SEGMENT-CONTENT
    if (segmentContent.tagName !== 'ION-SEGMENT-CONTENT') {
      (0,_index_cfd9c1f2_js__WEBPACK_IMPORTED_MODULE_6__.d)(`[ion-segment-button] - Element with id="${this.contentId}" is not an <ion-segment-content> element.`);
      return;
    }
  }
  get hasLabel() {
