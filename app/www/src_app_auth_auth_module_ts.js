...
/* harmony import */ var _signup_signup_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./signup/signup.component */ 66101);
/* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./login/login.component */ 66539);
/* harmony import */ var _forgotpwd_forgotpwd_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./forgotpwd/forgotpwd.component */ 43863);
...
AuthRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
...
/***/ 43863:
/*!*******************************************************!*\
  !*** ./src/app/auth/forgotpwd/forgotpwd.component.ts ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _forgotpwd_component_html_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./forgotpwd.component.html?ngResource */ 57281);
...
.modal.d-block .modal-dialog { max-width: 420px; }
`, "",{"version":3,"sources":["webpack://./src/app/auth/login/login.component.css"],"names":[],"mappings":"AAAA;EACE,kBAAkB;AACpB;;AAEA;EACE,gBAAgB;AAClB;;AAEA;;EAEE,cAAc;AAChB;;AAEA;EACE,kBAAkB;AACpB;;AAEA;;EAEE,kBAAkB;EAClB,mBAAmB;EACnB,sBAAsB;AACxB;;AAEA;EACE,oBAAoB;AACtB;;AAEA,gCAAgC;AAChC;EACE,gBAAgB;EAChB,mBAAmB;AACrB;;AAEA,kBAAkB;AAClB,uBAAuB,WAAW,EAAE;AACpC,+BAA+B,gBAAgB,EAAE","sourcesContent":[".container {\n  font-size: 0.95rem;\n}\n\nh1.h4 {\n  font-weight: 600;\n}\n\n.form-label,\n.form-text {\n  color: #4b5563;\n}\n\n.invalid-feedback {\n  font-size: 0.85rem;\n}\n\n.form-control-sm,\n.btn-sm {\n  font-size: 0.92rem;\n  padding-top: .35rem;\n  padding-bottom: .35rem;\n}\n\n.btn.rounded-pill {\n  border-radius: 50rem;\n}\n\n/* Forgot-password inline card */\n.reset-card {\n  max-width: 560px;\n  margin: 16px auto 0;\n}\n\n/* Modal helpers */\n.modal-backdrop.show { opacity: .4; }\n.modal.d-block .modal-dialog { max-width: 420px; }\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./login/login.component */ 66539);
/* harmony import */ var _signup_signup_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./signup/signup.component */ 66101);
/* harmony import */ var _forgotpwd_forgotpwd_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./forgotpwd/forgotpwd.component */ 43863);
/* harmony import */ var godigital_lib__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! godigital-lib */ 83);
/* harmony import */ var _auth_router_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./auth.router.module */ 8504);
...
AuthModule = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.NgModule)({
  ...
  imports: [_angular_common__WEBPACK_IMPORTED_MODULE_6__.CommonModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_7__.IonicModule, _auth_router_module__WEBPACK_IMPORTED_MODULE_3__.AuthRoutingModule, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormsModule, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.ReactiveFormsModule, ngx_cookie__WEBPACK_IMPORTED_MODULE_9__.CookieModule.forRoot(), godigital_lib__WEBPACK_IMPORTED_MODULE_10__.GodigitalbModule],
  providers: []
})], AuthModule);
...
/* harmony import */ var _Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 89204);
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! tslib */ 27824);
/* harmony import */ var _signup_component_html_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./signup.component.html?ngResource */ 3887);
/* harmony import */ var _signup_component_css_ngResource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./signup.component.css?ngResource */ 72174);
    ...
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      try {
        for (const file of Array.from(files)) {
          const url = yield _this.storeDb.uploadFile(dir, file);
  ...
  signupWithEmail() {
    ...
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      try {
        ...
        // 3) save to RTDB
        yield _this2.storeDb.updateObject(godigital_lib__WEBPACK_IMPORTED_MODULE_4__.OBJECTNAME.bnUsers, profile, uid);
  ...
  signupWithGoogle() {
    ...
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      try {
        ...
        yield _this3.storeDb.updateObject(godigital_lib__WEBPACK_IMPORTED_MODULE_4__.OBJECTNAME.bnUsers, profile, uid);
...
/* harmony import */ var _login_component_html_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./login.component.html?ngResource */ 81957);
/* harmony import */ var _login_component_css_ngResource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./login.component.css?ngResource */ 45984);
...
/* harmony import */ var _auth_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../auth.service */ 55498);
...
let LoginComponent = class LoginComponent {
  ...
  // redirection
  redirectTo = null;
  constructor(fb, users, router, route, utilSvc, storeDb, authSvc) {
    this.fb = fb;
    this.users = users;
    this.router = router;
    this.route = route;
  ...
  loginWithEmail() {
    ...
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      try {
        ...
        [status, user] = yield _this.authSvc.localUtilsSvc.processLogin(v.email, v.password, undefined);
        _this.authSvc.wnGuest = user;
        _this.authSvc.mainSvc.setLoggedUser(user);
      ...
      try {
        ...
        try {
          ...
          if (uid) {
            ...
            yield _this2.storeDb.partialUpdateObject(godigital_lib__WEBPACK_IMPORTED_MODULE_5__.OBJECTNAME.bnUsers, patch, uid);
            // reload full profile if needed
            const full = yield _this2.storeDb.getObject(godigital_lib__WEBPACK_IMPORTED_MODULE_5__.OBJECTNAME.bnUsers, uid);
            _this2.authSvc.wnGuest = full;
            _this2.authSvc.mainSvc.setLoggedUser(full);
          }
...
/***/ 72174:
/*!*************************************************************!*\
  !*** ./src/app/auth/signup/signup.component.css?ngResource ***!
  \*************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(___CSS_LOADER_API_SOURCEMAP_IMPORT___);
// Module
___CSS_LOADER_EXPORT___.push([module.id, `/* Keep Bootstrap look; just nudge sizes down a bit */
.container {
  font-size: 0.95rem;
}
...
/* Modal helpers (Bootstrap-like when using *ngIf) */
.modal-backdrop.show {
  opacity: .4;
}
...
`, "",{"version":3,"sources":["webpack://./src/app/auth/signup/signup.component.css"],"names":[],"mappings":"AAAA,qDAAqD;AACrD;EACE,kBAAkB;AACpB;;AAEA;EACE,gBAAgB;AAClB;;AAEA;;EAEE,cAAc;AAChB;;AAEA;;EAEE,kBAAkB;AACpB;;AAEA,8BAA8B;AAC9B;;;EAGE,kBAAkB;EAClB,mBAAmB;EACnB,sBAAsB;AACxB;;AAEA;EACE,oBAAoB;AACtB;;AAEA,oDAAoD;AACpD;EACE,WAAW;AACb;AACA;EACE,gBAAgB;AAClB","sourcesContent":["/* Keep Bootstrap look; just nudge sizes down a bit */\n.container {\n  font-size: 0.95rem;\n}\n\nh1.h4 {\n  font-weight: 600;\n}\n\n.form-label,\n.form-text {\n  color: #4b5563;\n}\n\n.invalid-feedback,\n.text-danger {\n  font-size: 0.85rem;\n}\n\n/* Small controls consistent */\n.form-control-sm,\n.form-select-sm,\n.btn-sm {\n  font-size: 0.92rem;\n  padding-top: .35rem;\n  padding-bottom: .35rem;\n}\n\n.btn.rounded-pill {\n  border-radius: 50rem;\n}\n\n/* Modal helpers (Bootstrap-like when using *ngIf) */\n.modal-backdrop.show {\n  opacity: .4;\n}\n.modal.d-block .modal-dialog {\n  max-width: 460px;\n}\n"],"sourceRoot":""}]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___.toString();
