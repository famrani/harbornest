...
class ServicesService {
  ...
  loginOrValidateUser(email, password, firebaseUid, verifyEmail) {
    var _this18 = this;
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      yield _this18.ensureFirebaseReady();
      const auth = _this18.utilSvc.mauth;
      if (!auth || typeof auth.signInWithEmailAndPassword !== 'function') {
        throw [AUTHSTATUS.UNKNOWNERROR, new Error('Firebase Authentication is not initialized.')];
      }
  ...
  ensureFirebaseReady() {
    var _this19 = this;
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this19.utilSvc.mauth && _this19.utilSvc.mdb) {
        return;
      }
      const storedPlatform = String(_this19.utilSvc.getPlatformEnv() || '').trim();
      const platform = ['dev', 'test', 'prod'].includes(storedPlatform) ? storedPlatform : undefined;
      yield _this19.bootstrap(platform);
    })();
  }
  ...
  setLoggedUser(value) {
    ...
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (value) {
        _this20.utilSvc.setUid(value.userId);
        _this20.bnUser = value;
        _this20.bnUserO.next(value);
      } else {
        _this20.utilSvc.clearUid();
        _this20.bnUser = null;
        _this20.bnUserO.next(null);
      }
    })();
  }
  getLanguage() {
    ...
    return new Promise(/*#__PURE__*/function () {
      var _ref22 = (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resolve, reject) {
        ...
        if (source === 'url') {
            ...
            _this21.http.get(_this21.utilSvc.backendURL + 'store/downloadUrl', {
              ...
              switch (data.type) {
                ...
                case _angular_common_http__WEBPACK_IMPORTED_MODULE_11__.HttpEventType.DownloadProgress:
                  if (data && data.total) {
                    _this21.progress = Math.round(data.loaded / data.total * 100);
                  }
                  break;
          ...
          if (event1) {
            _this21.storeDbSvc.uploadMedia(undefined, event1, directory).then(temp1 => {
              const thumb = temp1;
  ...
  bootstrap(envPlatform) {
    var _this22 = this;
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this22.utilSvc.mauth && _this22.utilSvc.mdb) {
        return;
      }
      if (!_this22.bootstrapPromise) {
        _this22.bootstrapPromise = (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
          const env = envPlatform ? {
            platform: envPlatform
          } : {};
          yield _this22.readConfigFile(env);
          yield _this22.initBEService(env);
          yield _this22.initStorageFb(env);
        })();
      }
      try {
        yield _this22.bootstrapPromise;
      } finally {
        _this22.bootstrapPromise = undefined;
      }
    })();
  }
  /**
...
"use strict";
module.exports = "<header class=\"site-header\">\n  <div class=\"container header-bar\">\n    <a class=\"brand\" [routerLink]=\"(homeRoute) | resourceRoute\" (click)=\"closeMenu()\">\n      <img class=\"brand-logo\" [src]=\"logoUrl\" [alt]=\"t('brand.name', t('brand'))\" />\n      <span class=\"brand-text\">\n        <strong>{{ t('brand.name', t('brand')) }}</strong>\n        <small>{{ t('brandTagline') }}</small>\n      </span>\n    </a>\n\n    <button class=\"menu-toggle\" type=\"button\" (click)=\"toggleMenu()\" [attr.aria-label]=\"t('nav.openMenu')\">\n      ☰\n    </button>\n\n    <nav class=\"main-nav\" [class.open]=\"menuOpen\">\n      <details class=\"nav-dropdown\" *ngIf=\"showCustomerNavigation\" (toggle)=\"onDropdownToggle($event)\">\n        <summary>{{ discoverLabel }}</summary>\n        <div class=\"dropdown-panel\">\n          <a [routerLink]=\"'/bateau' | resourceRoute\" routerLinkActive=\"active\" (click)=\"closeMenu()\">{{ boatMenuLabel }}</a>\n          <a [routerLink]=\"'/crew' | resourceRoute\" routerLinkActive=\"active\" (click)=\"closeMenu()\">{{ crewLabel }}</a>\n          <a [routerLink]=\"'/sorties' | resourceRoute\" routerLinkActive=\"active\" (click)=\"closeMenu()\">{{ itinerariesMenuLabel }}</a>\n        </div>\n      </details>\n      <a *ngIf=\"showCustomerNavigation\" [routerLink]=\"'/reserver' | resourceRoute\" routerLinkActive=\"active\" (click)=\"closeMenu()\">{{ reserveLabel }}</a>\n\n      <details class=\"nav-dropdown\" *ngIf=\"showAdminNavigation\" (toggle)=\"onDropdownToggle($event)\">\n        <summary>{{ managementLabel }}</summary>\n        <div class=\"dropdown-panel admin-navigation-panel\">\n          <a [routerLink]=\"'/admin/reservations' | resourceRoute\" routerLinkActive=\"active\" (click)=\"closeMenu()\">{{ reservationsLabel }}</a>\n          <a [routerLink]=\"'/admin/calendar' | resourceRoute\" routerLinkActive=\"active\" (click)=\"closeMenu()\">{{ calendarLabel }}</a>\n          <a [routerLink]=\"'/admin/site-content' | resourceRoute\" routerLinkActive=\"active\" (click)=\"closeMenu()\">{{ siteContentLabel }}</a>\n          <a [routerLink]=\"'/admin/pricing-model' | resourceRoute\" routerLinkActive=\"active\" (click)=\"closeMenu()\">{{ pricingModelLabel }}</a>\n          <a [routerLink]=\"'/admin/feedbacks' | resourceRoute\" routerLinkActive=\"active\" (click)=\"closeMenu()\">{{ adminFeedbacksLabel }}</a>\n        </div>\n      </details>\n\n      <button *ngIf=\"isAdmin\" class=\"owner-view-switch\" type=\"button\" (click)=\"switchOwnerView()\">\n        <span aria-hidden=\"true\">⇄</span>{{ switchOwnerViewLabel }}\n      </button>\n\n      <div class=\"language-switcher\">\n        <select [value]=\"currentLanguage\" (change)=\"changeLanguage($any($event.target).value)\" [attr.aria-label]=\"t('nav.languageSelector')\">\n          <option value=\"fr\">{{ 'layout.languages.fr' | siteText:'Français' }}</option>\n          <option value=\"en\">{{ 'layout.languages.en' | siteText:'English' }}</option>\n          <option value=\"es\">{{ 'layout.languages.es' | siteText:'Español' }}</option>\n          <option value=\"it\">{{ 'layout.languages.it' | siteText:'Italiano' }}</option>\n          <option value=\"de\">{{ 'layout.languages.de' | siteText:'Deutsch' }}</option>\n          <option value=\"nl\">{{ 'layout.languages.nl' | siteText:'Nederlands' }}</option>\n          <option value=\"ru\">{{ 'layout.languages.ru' | siteText:'Русский' }}</option>\n        </select>\n      </div>\n\n      <details class=\"nav-dropdown account-dropdown\" (toggle)=\"onDropdownToggle($event)\">\n        <summary>{{ accountSummaryLabel }}</summary>\n\n        <div class=\"dropdown-panel dropdown-panel-right\" *ngIf=\"!isLoggedIn\">\n          <a [routerLink]=\"'/login' | resourceRoute\" routerLinkActive=\"active\" (click)=\"closeMenu()\">{{ loginLabel }}</a>\n          <a [routerLink]=\"'/signup' | resourceRoute\" routerLinkActive=\"active\" (click)=\"closeMenu()\">{{ signupLabel }}</a>\n        </div>\n\n        <div class=\"dropdown-panel dropdown-panel-right account-admin-panel\" *ngIf=\"isLoggedIn && isAdmin\">\n          <a [routerLink]=\"'/my-profile' | resourceRoute\" routerLinkActive=\"active\" (click)=\"closeMenu()\">{{ myProfileLabel }}</a>\n          <button class=\"dropdown-action\" type=\"button\" (click)=\"switchOwnerView()\">{{ switchOwnerViewLabel }}</button>\n          <button class=\"dropdown-action\" type=\"button\" (click)=\"logout()\">{{ logoutLabel }}</button>\n        </div>\n\n        <div class=\"dropdown-panel dropdown-panel-right account-customer-panel\" *ngIf=\"isLoggedIn && isCustomer\">\n          <a [routerLink]=\"'/my-profile' | resourceRoute\" routerLinkActive=\"active\" (click)=\"closeMenu()\">{{ myProfileLabel }}</a>\n          <a [routerLink]=\"'/my-bookings' | resourceRoute\" routerLinkActive=\"active\" (click)=\"closeMenu()\">{{ reservationsLabel }}</a>\n          <a [routerLink]=\"'/my-feedbacks' | resourceRoute\" routerLinkActive=\"active\" (click)=\"closeMenu()\">{{ myFeedbacksLabel }}</a>\n          <button class=\"dropdown-action\" type=\"button\" (click)=\"logout()\">{{ logoutLabel }}</button>\n        </div>\n      </details>\n    </nav>\n  </div>\n</header>\n";
...
/* harmony export */ });
const sharedImages = {
  hero: 'boat/alegria/img/home/home-hero-generic.jpg',
  boatHero: 'boat/alegria/img/boat/bali4.1/bali-41-4.jpg',
  gallery: ['boat/alegria/img/boat/bali4.1/bali-41-2.jpg', 'boat/alegria/img/boat/bali4.1/bali-41-3.jpg', 'boat/alegria/img/boat/bali4.1/bali-41-4.jpg', 'boat/alegria/img/boat/bali4.1/bali-41-5.jpg', 'boat/alegria/img/boat/bali4.1/bali-41-1.jpg', 'boat/alegria/img/boat/bali4.1/bali-41-6.jpg', 'boat/alegria/img/boat/bali4.1/bali-41-7.jpg', 'boat/alegria/img/boat/bali4.1/bali-41-8.jpg', 'boat/alegria/img/boat/bali4.1/bali-41-9.jpg', 'boat/alegria/img/boat/bali4.1/bali-41-10.jpg', 'boat/alegria/img/boat/bali4.1/bali-41-11.jpg', 'boat/alegria/img/boat/bali4.1/bali-41-12.jpg', 'boat/alegria/img/boat/bali4.1/bali-41-13.jpg'],
  de1: 'boat/alegria/img/events/de/de1.png',
  sunset1: 'boat/alegria/img/events/sunset/sunset1.jpg',
  business1: 'boat/alegria/img/events/business-meeting/business-meeting1.jpg',
  party1: 'boat/alegria/img/events/party/party1.jpg'
};
const SITE_CONTENT = {
  fr: {
    contactInfo: {
...
/***/ 14990:
/*!*******************************************************!*\
  !*** ./src/app/services/resource-registry.service.ts ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ResourceRegistryService: () => (/* binding */ ResourceRegistryService)
/* harmony export */ });
/* harmony import */ var _Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 89204);
...
let ResourceRegistryService = class ResourceRegistryService {
  ...
  listTypes() {
    var _this = this;
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const registry = yield _this.http.get(`${_this.firebaseUrl}/resources.json`).toPromise().catch(() => ({}));
      return _this.supported.map(type => {
        const entries = registry && registry[type] && typeof registry[type] === 'object' ? registry[type] : {};
        const count = Object.values(entries).filter(v => v && v.enabled !== false).length;
        return {
          type,
          label: _this.labels[type],
          count
        };
      });
    })();
  ...
  list(type) {
    var _this2 = this;
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (!_this2.supported.includes(type)) return [];
      const raw = yield _this2.http.get(`${_this2.firebaseUrl}/resources/${encodeURIComponent(type)}.json`).toPromise().catch(() => ({}));
      if (!raw || typeof raw !== 'object') return [];
      return Object.keys(raw).map(resourceId => ({
        resourceId,
        resourceType: type,
        ...(raw[resourceId] || {})
...
ResourceRegistryService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
  providedIn: 'root'
...
/***/ 19337:
/*!*************************************************!*\
  !*** ./src/app/services/resource-route.pipe.ts ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ResourceRoutePipe: () => (/* binding */ ResourceRoutePipe)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 27824);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37580);
/* harmony import */ var _boat_routing__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./boat-routing */ 91682);



let ResourceRoutePipe = class ResourceRoutePipe {
  transform(value) {
    if (value == null) return (0,_boat_routing__WEBPACK_IMPORTED_MODULE_0__.boatPath)('/home');
    let route;
    ...
    return (0,_boat_routing__WEBPACK_IMPORTED_MODULE_0__.boatPath)(route || '/home');
  }
};
ResourceRoutePipe = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.Pipe)({
  name: 'resourceRoute',
  standalone: true
})], ResourceRoutePipe);
...
/***/ 19924:
/*!**************************************************************************!*\
  !*** ./src/app/legacy-route-redirect/legacy-route-redirect.component.ts ***!
  \**************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   LegacyRouteRedirectComponent: () => (/* binding */ LegacyRouteRedirectComponent)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tslib */ 27824);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 37580);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ 50085);
/* harmony import */ var _services_boat_routing__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/boat-routing */ 91682);




let LegacyRouteRedirectComponent = class LegacyRouteRedirectComponent {
  router;
  constructor(router) {
    this.router = router;
  }
  ngOnInit() {
    const u = this.router.url || '/home',
      h = u.split('#'),
      q = h[0].split('?');
    window.location.replace((0,_services_boat_routing__WEBPACK_IMPORTED_MODULE_0__.boatPath)(q[0] === '/' ? '/home' : q[0]) + (q[1] ? '?' + q[1] : '') + (h[1] ? '#' + h[1] : ''));
  }
  static ctorParameters = () => [{
    type: _angular_router__WEBPACK_IMPORTED_MODULE_1__.Router
  }];
};
LegacyRouteRedirectComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Component)({
  selector: 'app-legacy-route-redirect',
  template: ''
})], LegacyRouteRedirectComponent);
...
/* harmony import */ var _services_boat_routing__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../services/boat-routing */ 91682);
...
/* harmony import */ var _services_resource_context_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/resource-context.service */ 54560);
...
let OfferApiService = class OfferApiService {
  ...
  firebaseUrl = 'https://adn-dev-4d05d.firebaseio.com';
  constructor(http, utilsSvc, resourceContext) {
    this.http = http;
    this.utilsSvc = utilsSvc;
    this.resourceContext = resourceContext;
  }
  getOffers() {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.from)(this.readCollection(this.offersCollection)).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.catchError)(() => (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.of)([])));
  }
  getOffer(id) {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.from)(this.readOfferWithPaymentState(id)).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.catchError)(() => (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.of)(undefined)));
  }
  ...
  saveOffer(input) {
    ...
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const now = Date.now();
      const boatId = String(input.boatId || _this.resourceContext.boatId);
      const fleetBoat = yield _this.readFirebasePath(`/${_this.resourceContext.scopedPath('bnFleet')}`).catch(() => ({}));
  ...
  createManualHistoricalBookingRecord(input) {
    ...
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const boatId = String(input.boatId || _this12.resourceContext.boatId);
      const fleetBoat = yield _this12.readFirebasePath(`/${_this12.resourceContext.scopedPath('bnFleet')}`).catch(() => ({}));
      const ownerId = String(input.ownerId || fleetBoat?.ownerId || boatId);
      const booking = {
        bookingId,
        offerId: bookingId,
  ...
  createExternalBookingRecord(offer) {
    ...
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const booking = {
        ...
        ownerId: anyOffer.ownerId || _this13.resourceContext.boatId,
  ...
  markDepositPaidFromStripeReturn(offerId, payload = {}) {
    ...
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const verified = yield _this17.postFirstAvailable([`${_this17.baseUrl}/pay/outing-deposit-complete`, `${_this17.baseUrl}/api/payments/complete-deposit-payment`, `${_this17.baseUrl}/stripe/deposit-complete`], {
        ...
        bookingId: offerId,
        offerId,
        ownerId: current.ownerId || _this17.resourceContext.boatId,
  ...
  patchBookingDepositState(offerId, offer, payload = {}) {
    ...
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield _this18.writeItem(_this18.bookingsCollection, bookingId, {
        ...
        bookingId,
        offerId,
        ownerId: offer.ownerId || existing?.ownerId || _this18.resourceContext.boatId,
  ...
  createDepositCheckout(offer) {
    ...
    return this.http.post(`${this.baseUrl}/pay/outing-deposit-checkout`, {
      ...
      ownerId: offer.ownerId || this.resourceContext.boatId,
      ...
      paymentType: 'deposit',
      currency: 'eur',
      successUrl: `${window.location.origin}${(0,_services_boat_routing__WEBPACK_IMPORTED_MODULE_1__.boatPath)("/offer")}/${offer.offerId}?payment=success&session_id={CHECKOUT_SESSION_ID}`,
      cancelUrl: `${window.location.origin}${(0,_services_boat_routing__WEBPACK_IMPORTED_MODULE_1__.boatPath)("/offer")}/${offer.offerId}?payment=cancelled`
    }, {
      withCredentials: true
    });
  }
  markWarrantyRegisteredFromStripeReturn(offerId, payload = {}) {
    ...
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if (sessionId) {
        try {
          backendResult = yield _this19.completeWarrantySetup(offerId, sessionId, current.ownerId || _this19.resourceContext.boatId).toPromise();
        } catch {
  ...
  createWarrantySetup(offer) {
    const payload = {
      ...
      currency: 'eur',
      successUrl: `${window.location.origin}${(0,_services_boat_routing__WEBPACK_IMPORTED_MODULE_1__.boatPath)("/offer")}/${offer.offerId}?warranty=success&session_id={CHECKOUT_SESSION_ID}`,
      cancelUrl: `${window.location.origin}${(0,_services_boat_routing__WEBPACK_IMPORTED_MODULE_1__.boatPath)("/offer")}/${offer.offerId}?warranty=cancelled`
    };
  ...
  completeWarrantySetup(offerId, sessionId, ownerId = this.resourceContext.boatId) {
    const payload = {
      bookingId: offerId,
      offerId,
      ownerId,
  ...
  buildOfferLink(offerId) {
    ...
    return `${origin}${(0,_services_boat_routing__WEBPACK_IMPORTED_MODULE_1__.boatPath)("/offer")}/${encodeURIComponent(offerId)}`;
  }
  buildOfferNotificationPayload(offer, offerLink) {
    ...
    return {
      ...
      createdTS: Date.now(),
      boatId: offer.boatId || this.resourceContext.boatId,
      ownerId: offer.ownerId || this.resourceContext.boatId
    };
  }
  ...
  queueOfferNotification(offer, channel, payload, now) {
    ...
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield _this21.writeItem(`${_this21.offersCollection}/${offerId}/events`, id, {
        ...
        modifiedTS: now,
        source: 'admin_offer',
        boatId: offer.boatId || _this21.resourceContext.boatId,
        ownerId: offer.ownerId || _this21.resourceContext.boatId
      });
    })();
  }
  ...
  scopedCollection(collection) {
    const p = String(collection || '').replace(/^\/+|\/+$/g, '').split('/');
    const root = p.shift() || '';
    return this.resourceContext.scopedPath(root, p.join('/'));
  }
  readCollection(collection) {
    var _this24 = this;
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const value = yield _this24.http.get(`${_this24.firebaseUrl}/${_this24.scopedCollection(collection)}.json`).toPromise();
      if (!value) return [];
      return Object.keys(value).map(key => ({
        ...value[key],
        offerId: value[key]?.offerId || key
      })).filter(offer => String(offer.boatId || 'alegria') === _this24.resourceContext.boatId);
    })();
  }
  readItem(collection, id) {
    var _this25 = this;
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const value = yield _this25.http.get(`${_this25.firebaseUrl}/${_this25.scopedCollection(collection)}/${id}.json`).toPromise();
      return value ? {
        ...value,
  ...
  deleteItem(collection, id) {
    var _this26 = this;
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      yield _this26.http.delete(`${_this26.firebaseUrl}/${_this26.scopedCollection(collection)}/${id}.json`).toPromise();
    })();
  }
  writeItem(collection, id, value) {
    var _this27 = this;
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      yield _this27.http.put(`${_this27.firebaseUrl}/${_this27.scopedCollection(collection)}/${id}.json`, value).toPromise();
    })();
  }
  static ctorParameters = () => [{
    ...
    type: _services_resource_context_service__WEBPACK_IMPORTED_MODULE_2__.ResourceContextService
  }];
};
OfferApiService = (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_10__.Injectable)({
  providedIn: 'root'
})], OfferApiService);
...
/***/ 24016:
/*!*********************************************************************************!*\
  !*** ./src/app/resource-dashboard/resource-dashboard.component.html?ngResource ***!
  \*********************************************************************************/
/***/ ((module) => {

"use strict";
module.exports = "<div class=\"registry-page\">\n  <header><div class=\"brand\">HarborNest</div><h1>Resources</h1><p>Select the type of asset you want to manage.</p></header>\n  <div class=\"grid\" *ngIf=\"!loading\">\n    <button class=\"type-card\" *ngFor=\"let item of types\" (click)=\"open(item.type)\">\n      <span class=\"icon\">{{ item.type === 'boat' ? '⛵' : item.type === 'place' ? '🏠' : item.type === 'car' ? '🚗' : '🏊' }}</span>\n      <span class=\"title\">{{ item.label }}</span><span class=\"count\">{{ item.count }} resource{{ item.count === 1 ? '' : 's' }}</span>\n    </button>\n  </div>\n  <p *ngIf=\"loading\">Loading resources…</p>\n</div>\n";
...
/***/ 26830:
/*!***********************************************************************!*\
  !*** ./src/app/resource-list/resource-list.component.scss?ngResource ***!
  \***********************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(___CSS_LOADER_API_SOURCEMAP_IMPORT___);
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.list-page {
  min-height: 100vh;
  padding: 48px 6vw;
  background: #f6f8fa;
  color: #17202a;
...
.body span {
  font-weight: 700;
}`, "",{"version":3,"sources":["webpack://./src/app/resource-list/resource-list.component.scss"],"names":[],"mappings":"AAAA;EAAW,iBAAA;EAAiB,iBAAA;EAAiB,mBAAA;EAAmB,cAAA;EAAc,8BAAA;AAM9E;;AAN2G;EAAM,SAAA;EAAS,uBAAA;EAAuB,eAAA;EAAe,UAAA;EAAU,eAAA;AAc1K;;AAdyL;EAAG,eAAA;EAAe,kBAAA;AAmB3M;;AAnB6N;EAAa,cAAA;AAuB1O;;AAvBwP;EAAM,aAAA;EAAa,6DAAA;EAA2D,SAAA;EAAS,gBAAA;AA8B/U;;AA9B+V;EAAe,gBAAA;EAAgB,yBAAA;EAAyB,mBAAA;EAAmB,gBAAA;EAAgB,eAAA;EAAe,0CAAA;AAuCzc;;AAvC+e;EAAmB,WAAA;EAAW,aAAA;EAAa,iBAAA;AA6C1hB;;AA7C2iB;EAAM,aAAA;AAiDjjB;;AAjD8jB;EAAS,eAAA;AAqDvkB;;AArDslB;EAAQ,cAAA;EAAc,gBAAA;AA0D5mB;;AA1D4nB;EAAW,gBAAA;AA8DvoB","sourcesContent":[".list-page{min-height:100vh;padding:48px 6vw;background:#f6f8fa;color:#17202a;font-family:Arial,sans-serif}.back{border:0;background:transparent;cursor:pointer;padding:0;font-size:15px}h1{font-size:38px;margin:28px 0 6px}.list-page>p{color:#667085}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(270px,360px));gap:24px;margin-top:34px}.resource-card{overflow:hidden;border:1px solid #e2e6ea;border-radius:18px;background:#fff;cursor:pointer;box-shadow:0 8px 24px rgba(0,0,0,.05)}.resource-card img{width:100%;height:190px;object-fit:cover}.body{padding:22px}.body h2{margin:0 0 8px}.body p{color:#667085;min-height:38px}.body span{font-weight:700}\n"],"sourceRoot":""}]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___.toString();
...
.owner-view-switch:hover,
.owner-view-switch:focus-visible {
...
/* harmony import */ var _services_resource_context_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../services/resource-context.service */ 54560);
/* harmony import */ var _services_resource_registry_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../services/resource-registry.service */ 14990);
...
let HomefooterComponent = class HomefooterComponent {
  ...
  constructor(languageService, mainSvc, siteContentService, resourceContext, resourceRegistry) {
    this.languageService = languageService;
    this.mainSvc = mainSvc;
    this.siteContentService = siteContentService;
    this.resourceContext = resourceContext;
  ...
  loadResourceName() {
    var _this2 = this;
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const type = _this2.resourceContext.resourceType;
      const id = _this2.resourceContext.resourceId;
      try {
        const items = yield _this2.resourceRegistry.list(type);
        const current = items.find(item => item.resourceId === id);
        _this2.resourceName = current?.name || _this2.safeBrandName() || id || 'HarborNest';
      } catch {
        _this2.resourceName = _this2.safeBrandName() || id || 'HarborNest';
      }
    })();
  }
  safeBrandName() {
  ...
  static ctorParameters = () => [{
    ...
    type: _services_resource_context_service__WEBPACK_IMPORTED_MODULE_6__.ResourceContextService
  }, {
    type: _services_resource_registry_service__WEBPACK_IMPORTED_MODULE_7__.ResourceRegistryService
  }];
};
HomefooterComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_10__.Component)({
  standalone: false,
...
/***/ 45792:
/*!********************************************************************!*\
  !*** ./src/app/resource-dashboard/resource-dashboard.component.ts ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ResourceDashboardComponent: () => (/* binding */ ResourceDashboardComponent)
/* harmony export */ });
/* harmony import */ var _Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 89204);
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! tslib */ 27824);
/* harmony import */ var _resource_dashboard_component_html_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./resource-dashboard.component.html?ngResource */ 24016);
/* harmony import */ var _resource_dashboard_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./resource-dashboard.component.scss?ngResource */ 78958);
/* harmony import */ var _resource_dashboard_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_resource_dashboard_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _services_resource_registry_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/resource-registry.service */ 14990);
...
let ResourceDashboardComponent = class ResourceDashboardComponent {
  registry;
  router;
  types = [];
  loading = true;
  ...
  ngOnInit() {
    var _this = this;
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this.types = yield _this.registry.listTypes();
      _this.loading = false;
    })();
  }
  open(type) {
  ...
  static ctorParameters = () => [{
    type: _services_resource_registry_service__WEBPACK_IMPORTED_MODULE_3__.ResourceRegistryService
  }, {
    type: _angular_router__WEBPACK_IMPORTED_MODULE_4__.Router
  }];
};
ResourceDashboardComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
  selector: 'app-resource-dashboard',
  template: _resource_dashboard_component_html_ngResource__WEBPACK_IMPORTED_MODULE_1__,
  styles: [(_resource_dashboard_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_2___default())]
...
/* harmony import */ var _services_resource_route_pipe__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../services/resource-route.pipe */ 19337);
...
LayoutModule = (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_9__.NgModule)({
  ...
  imports: [_angular_common__WEBPACK_IMPORTED_MODULE_10__.CommonModule, _services_resource_route_pipe__WEBPACK_IMPORTED_MODULE_7__.ResourceRoutePipe, _angular_router__WEBPACK_IMPORTED_MODULE_11__.RouterModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_12__.IonicModule, _angular_forms__WEBPACK_IMPORTED_MODULE_13__.FormsModule, _angular_forms__WEBPACK_IMPORTED_MODULE_13__.ReactiveFormsModule, ngx_spinner__WEBPACK_IMPORTED_MODULE_14__.NgxSpinnerModule, _layout_router_module__WEBPACK_IMPORTED_MODULE_4__.LayoutRoutingModule, _home_site_text_pipe__WEBPACK_IMPORTED_MODULE_6__.SiteTextPipe],
...
let HomeheaderComponent = class HomeheaderComponent {
  ...
  siteContentService;
  privateMedia;
  ownerViewStorageKey = 'alegria-owner-view';
  logoUrl;
  menuOpen = false;
  ownerView = 'admin';
  currentLanguage = 'fr';
  ...
  restoreOwnerView() {
    ...
    if (this.router.url.startsWith('/admin')) {
      this.ownerView = 'admin';
      return;
    }
    try {
      const storedView = localStorage.getItem(this.ownerViewStorageKey);
      this.ownerView = storedView === 'customer' ? 'customer' : 'admin';
    } catch {
      this.ownerView = 'admin';
    }
  }
  switchOwnerView() {
    this.ownerView = this.ownerView === 'admin' ? 'customer' : 'admin';
    try {
      localStorage.setItem(this.ownerViewStorageKey, this.ownerView);
    } catch {}
    if (typeof window !== 'undefined') {
      window.dispatchEvent(new CustomEvent('alegria-owner-view-change', {
        detail: this.ownerView
      }));
    }
    this.closeMenu();
  ...
  get homeRoute() {
    return this.isAdmin && this.ownerView === 'admin' ? '/home' : '/';
  }
  logout() {
    const svc = this.mainSvc;
  ...
  get showCustomerNavigation() {
    return !this.isAdmin || this.ownerView === 'customer';
  }
  get showAdminNavigation() {
    return this.isAdmin && this.ownerView === 'admin';
  }
  get firstName() {
  ...
  get switchOwnerViewLabel() {
    ...
    const adminLabels = {
      ...
      de: 'Adminansicht',
      nl: 'Beheerweergave',
      ru: 'Вид администратора'
    };
    const labels = this.ownerView === 'admin' ? customerLabels : adminLabels;
    return labels[this.currentLanguage] || labels.fr;
  }
  get destinationsLabel() {
    const labels = {
      fr: 'Destinations & itinéraires',
      en: 'Destinations & itineraries',
      es: 'Destinos e itinerarios',
      it: 'Destinazioni e itinerari',
      de: 'Ziele & Routen',
      nl: 'Bestemmingen & routes',
      ru: 'Направления и маршруты'
    };
    return labels[this.currentLanguage] || labels.fr;
  }
  get manageItinerariesLabel() {
    const labels = {
      fr: 'Gérer les itinéraires',
      en: 'Manage itineraries',
      es: 'Gestionar itinerarios',
      it: 'Gestire gli itinerari',
      de: 'Routen verwalten',
      nl: 'Routes beheren',
...
/* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @angular/platform-browser */ 53563);
/* harmony import */ var _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @angular/platform-browser/animations */ 43835);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! @angular/router */ 50085);
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @angular/common/http */ 93262);
...
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! @angular/common */ 35135);
...
/* harmony import */ var ngx_logger__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ngx-logger */ 66383);
...
/* harmony import */ var godigital_lib__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! godigital-lib */ 83);
...
/* harmony import */ var ngx_echarts__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ngx-echarts */ 15371);
/* harmony import */ var ngx_spinner__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ngx-spinner */ 61249);
/* harmony import */ var _legacy_route_redirect_legacy_route_redirect_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./legacy-route-redirect/legacy-route-redirect.component */ 19924);
/* harmony import */ var _resource_dashboard_resource_dashboard_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./resource-dashboard/resource-dashboard.component */ 45792);
/* harmony import */ var _resource_list_resource_list_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./resource-list/resource-list.component */ 65416);
...
AppModule = (0,tslib__WEBPACK_IMPORTED_MODULE_15__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_16__.NgModule)({
  declarations: [_legacy_route_redirect_legacy_route_redirect_component__WEBPACK_IMPORTED_MODULE_12__.LegacyRouteRedirectComponent, _resource_dashboard_resource_dashboard_component__WEBPACK_IMPORTED_MODULE_13__.ResourceDashboardComponent, _resource_list_resource_list_component__WEBPACK_IMPORTED_MODULE_14__.ResourceListComponent, _app_component__WEBPACK_IMPORTED_MODULE_7__.AppComponent, _page404_page404_component__WEBPACK_IMPORTED_MODULE_10__.Page404Component],
  imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_17__.BrowserModule, _app_routing_module__WEBPACK_IMPORTED_MODULE_6__.AppRoutingModule, _angular_common_http__WEBPACK_IMPORTED_MODULE_18__.HttpClientModule, godigital_lib__WEBPACK_IMPORTED_MODULE_19__.GodigitalbModule, _layout_layout_module__WEBPACK_IMPORTED_MODULE_8__.LayoutModule, ngx_spinner__WEBPACK_IMPORTED_MODULE_20__.NgxSpinnerModule, _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_21__.BrowserAnimationsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_22__.IonicModule, ngx_logger__WEBPACK_IMPORTED_MODULE_23__.LoggerModule.forRoot({
  ...
  }, godigital_lib__WEBPACK_IMPORTED_MODULE_19__.UtilsService, _awesome_cordova_plugins_barcode_scanner_ngx__WEBPACK_IMPORTED_MODULE_3__.BarcodeScanner, _angular_common__WEBPACK_IMPORTED_MODULE_27__.DatePipe, _awesome_cordova_plugins_geolocation_ngx__WEBPACK_IMPORTED_MODULE_0__.Geolocation, _awesome_cordova_plugins_native_geocoder_ngx__WEBPACK_IMPORTED_MODULE_1__.NativeGeocoder, ng2_haversine__WEBPACK_IMPORTED_MODULE_2__.HaversineService, {
...
/* harmony import */ var _boat_routing__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./boat-routing */ 91682);
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common */ 19770);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37580);
...
let SeoService = class SeoService {
  ...
  update(pathname) {
    ...
    const canonical = `${this.origin}${(0,_boat_routing__WEBPACK_IMPORTED_MODULE_0__.boatPath)(path)}`;
...
SeoService = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.Injectable)({
  providedIn: 'root'
})], SeoService);
...
/***/ 52488:
/*!***********************************************************************!*\
  !*** ./src/app/resource-list/resource-list.component.html?ngResource ***!
  \***********************************************************************/
/***/ ((module) => {

"use strict";
module.exports = "<div class=\"list-page\">\n  <button class=\"back\" (click)=\"back()\">← All resources</button>\n  <h1>{{ type | titlecase }}s</h1><p>Select a resource to open its workspace.</p>\n  <div class=\"grid\" *ngIf=\"!loading\">\n    <article class=\"resource-card\" *ngFor=\"let item of items\" (click)=\"open(item)\">\n      <img *ngIf=\"item.coverImage\" [src]=\"registry.mediaUrl(item.coverImage)\" [alt]=\"item.name || item.resourceId\">\n      <div class=\"body\"><h2>{{ item.name || item.resourceId }}</h2><p *ngIf=\"item.description\">{{ item.description }}</p><span>Open →</span></div>\n    </article>\n  </div>\n  <p *ngIf=\"!loading && !items.length\">No {{ type }} resources are registered yet.</p><p *ngIf=\"loading\">Loading…</p>\n</div>\n";
...
/***/ 54560:
/*!******************************************************!*\
  !*** ./src/app/services/resource-context.service.ts ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ResourceContextService: () => (/* binding */ ResourceContextService)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 27824);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37580);
/* harmony import */ var _boat_routing__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./boat-routing */ 91682);
...
let ResourceContextService = class ResourceContextService {
  get resourceType() {
    return (0,_boat_routing__WEBPACK_IMPORTED_MODULE_0__.activeAssetContext)().assetType;
  }
  get resourceId() {
    return (0,_boat_routing__WEBPACK_IMPORTED_MODULE_0__.activeAssetContext)().assetId;
  }
  ...
  get basePath() {
    return (0,_boat_routing__WEBPACK_IMPORTED_MODULE_0__.assetBasePath)(this.resourceType, this.resourceId);
  }
  setResource(resourceType, resourceId) {
    if (!(0,_boat_routing__WEBPACK_IMPORTED_MODULE_0__.validAssetType)(resourceType) || !(0,_boat_routing__WEBPACK_IMPORTED_MODULE_0__.validBoatId)(resourceId)) throw new Error('Invalid resource scope');
    if (typeof window !== 'undefined') window.location.assign((0,_boat_routing__WEBPACK_IMPORTED_MODULE_0__.boatPath)('/home', resourceId, resourceType));
  }
  setResourceId(resourceId) {
    if (!(0,_boat_routing__WEBPACK_IMPORTED_MODULE_0__.validBoatId)(resourceId)) throw new Error('Invalid resource ID');
    if (resourceId !== this.resourceId && typeof window !== 'undefined') {
      ...
      window.location.assign((0,_boat_routing__WEBPACK_IMPORTED_MODULE_0__.boatPath)(rest, resourceId, this.resourceType) + window.location.search + window.location.hash);
    }
    return resourceId;
  }
  /**
  ...
  scopedPath(root, suffix = '') {
    ...
    const flatOperational = new Set(['backendcalendar', 'backendfeedbacks', 'backendpayments', 'backendusers', 'bnBookings', 'bnProposals', 'bnSkippers']);
    if (flatOperational.has(r)) return [r, s].filter(Boolean).join('/');
    return [r, this.resourceType, this.resourceId, s].filter(Boolean).join('/');
  }
  route(path = '/') {
    return (0,_boat_routing__WEBPACK_IMPORTED_MODULE_0__.boatPath)(path, this.resourceId, this.resourceType);
  }
};
ResourceContextService = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.Injectable)({
  providedIn: 'root'
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ResourceListComponent: () => (/* binding */ ResourceListComponent)
/* harmony export */ });
/* harmony import */ var _Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 89204);
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! tslib */ 27824);
/* harmony import */ var _resource_list_component_html_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./resource-list.component.html?ngResource */ 52488);
/* harmony import */ var _resource_list_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./resource-list.component.scss?ngResource */ 26830);
/* harmony import */ var _resource_list_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_resource_list_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/core */ 37580);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/router */ 50085);
/* harmony import */ var _services_resource_registry_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/resource-registry.service */ 14990);
/* harmony import */ var _services_boat_routing__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/boat-routing */ 91682);
...
let ResourceListComponent = class ResourceListComponent {
  ...
  items = [];
  loading = true;
  constructor(registry, route, router) {
    this.registry = registry;
    this.route = route;
    this.router = router;
  }
  ngOnInit() {
    var _this = this;
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this.type = (_this.route.snapshot.paramMap.get('assetType') || '').toLowerCase();
      if (!(0,_services_boat_routing__WEBPACK_IMPORTED_MODULE_4__.validAssetType)(_this.type)) {
        _this.router.navigate(['/']);
        return;
      }
      _this.items = yield _this.registry.list(_this.type);
      _this.loading = false;
    })();
  }
  open(item) {
    this.router.navigate(['/', this.type, item.resourceId, 'home']);
  }
  back() {
...
ResourceListComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
  selector: 'app-resource-list',
  template: _resource_list_component_html_ngResource__WEBPACK_IMPORTED_MODULE_1__,
  styles: [(_resource_list_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_2___default())]
...
/* harmony import */ var _resource_context_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./resource-context.service */ 54560);
...
let PrivateMediaService = class PrivateMediaService {
  ...
  constructor(handler, resourceContext) {
    this.resourceContext = resourceContext;
  ...
  resolvePaths(paths) {
    ...
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if (missing.length) {
        try {
          const response = yield (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.firstValueFrom)(_this2.http.post(`${_this2.backendOrigin}/api/media/urls`, {
            paths: missing
          }));
  ...
  toObjectPath(value) {
    ...
    const canonicalPrefix = `${this.resourceContext.assetType}/${this.resourceContext.assetId}/img/`;
    const oldAlegriaPrefix = 'alegria/img/';
    const legacyPrefix = 'assets/img/';
    if (clean.startsWith(canonicalPrefix)) return clean;
    if (clean.startsWith(oldAlegriaPrefix) && this.resourceContext.assetType === 'boat' && this.resourceContext.assetId === 'alegria') return `${canonicalPrefix}${clean.slice(oldAlegriaPrefix.length)}`;
  ...
  static ctorParameters = () => [{
    ...
    type: _resource_context_service__WEBPACK_IMPORTED_MODULE_1__.ResourceContextService
  }];
};
PrivateMediaService = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.Injectable)({
  providedIn: 'root'
})], PrivateMediaService);
...
"use strict";
module.exports = "<footer class=\"site-footer-simple\">\n  <div class=\"container footer-simple\">\n    <div class=\"footer-left\">\n      © {{ year }} {{ resourceName }}\n    </div>\n\n    <div class=\"footer-center\">\n      {{ releaseLabel }} {{ mainSvc.version }}\n    </div>\n\n    <div class=\"footer-right\">\n      <a [routerLink]=\"'/contact' | resourceRoute\">{{ content?.footer?.contact || content?.nav?.contact }}</a>\n      <a [routerLink]=\"'/booking-process' | resourceRoute\">{{ bookingProcessLabel }}</a>\n      <a [routerLink]=\"'/sea-toys' | resourceRoute\">{{ seaToysLabel }}</a>\n      <a [routerLink]=\"'/terms' | resourceRoute\">{{ termsLabel }}</a>\n      <a [routerLink]=\"'/safety' | resourceRoute\">{{ safetyLabel }}</a>\n    </div>\n  </div>\n</footer>";
...
let SiteContentService = class SiteContentService {
  ...
  cached;
  rawSiteContent;
  constructor(http, resourceContext, privateMedia) {
    this.http = http;
    this.resourceContext = resourceContext;
    this.privateMedia = privateMedia;
  }
   ...
   *   /siteContent/{resourceType}/{resourceId}/{language}/...
   *
  ...
  getContent(forceRefresh = false) {
    ...
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      for (const baseUrl of _this.restDatabaseUrls) {
        try {
          const scoped = yield (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.firstValueFrom)(_this.http.get(`${baseUrl}/${_this.resourceContext.scopedPath('siteContent')}.json`).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_5__.timeout)(5000)));
  ...
  getRawContent(forceRefresh = false) {
    ...
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      for (const baseUrl of _this3.restDatabaseUrls) {
        try {
          _this3.rawSiteContent = yield (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.firstValueFrom)(_this3.http.get(`${baseUrl}/${_this3.resourceContext.scopedPath('siteContent')}.json`).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_5__.timeout)(5000)));
...
/***/ 78958:
/*!*********************************************************************************!*\
  !*** ./src/app/resource-dashboard/resource-dashboard.component.scss?ngResource ***!
  \*********************************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(___CSS_LOADER_API_SOURCEMAP_IMPORT___);
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.registry-page {
  min-height: 100vh;
  padding: 64px 6vw;
  background: #f6f8fa;
  color: #17202a;
...
.count {
  ...
  margin-top: 8px;
  color: #667085;
}`, "",{"version":3,"sources":["webpack://./src/app/resource-dashboard/resource-dashboard.component.scss"],"names":[],"mappings":"AAAA;EAAe,iBAAA;EAAiB,iBAAA;EAAiB,mBAAA;EAAmB,cAAA;EAAc,8BAAA;AAMlF;;AAN+G;EAAO,eAAA;EAAe,gBAAA;EAAgB,sBAAA;EAAqB,yBAAA;AAa1K;;AAbmM;EAAG,eAAA;EAAe,kBAAA;AAkBrN;;AAlBuO;EAAS,eAAA;EAAe,cAAA;AAuB/P;;AAvB6Q;EAAM,aAAA;EAAa,2DAAA;EAAyD,SAAA;EAAS,gBAAA;EAAgB,iBAAA;AA+BlX;;AA/BmY;EAAW,gBAAA;EAAgB,yBAAA;EAAyB,mBAAA;EAAmB,gBAAA;EAAgB,aAAA;EAAa,eAAA;EAAe,0CAAA;AAyCtf;;AAzC4hB;EAAiB,2BAAA;AA6C7iB;;AA7CwkB;EAAM,eAAA;EAAe,cAAA;EAAc,mBAAA;AAmD3mB;;AAnD8nB;EAAO,cAAA;EAAc,eAAA;EAAe,gBAAA;AAyDlqB;;AAzDkrB;EAAO,cAAA;EAAc,eAAA;EAAe,cAAA;AA+DttB","sourcesContent":[".registry-page{min-height:100vh;padding:64px 6vw;background:#f6f8fa;color:#17202a;font-family:Arial,sans-serif}.brand{font-size:18px;font-weight:700;letter-spacing:.08em;text-transform:uppercase}h1{font-size:42px;margin:18px 0 8px}header p{font-size:18px;color:#667085}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;margin-top:42px;max-width:1100px}.type-card{text-align:left;border:1px solid #e2e6ea;border-radius:18px;background:#fff;padding:28px;cursor:pointer;box-shadow:0 8px 24px rgba(0,0,0,.05)}.type-card:hover{transform:translateY(-2px)}.icon{font-size:36px;display:block;margin-bottom:28px}.title{display:block;font-size:24px;font-weight:700}.count{display:block;margin-top:8px;color:#667085}\n"],"sourceRoot":""}]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___.toString();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _app_services_boat_routing__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./app/services/boat-routing */ 91682);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/core */ 37580);
/* harmony import */ var _angular_platform_browser_dynamic__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/platform-browser-dynamic */ 52476);
...
(0,_app_services_boat_routing__WEBPACK_IMPORTED_MODULE_0__.initializeBoatRouting)();
if (_environments_environment__WEBPACK_IMPORTED_MODULE_3__.environment.production) {
  (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.enableProdMode)();
}
(0,_angular_platform_browser_dynamic__WEBPACK_IMPORTED_MODULE_1__.platformBrowserDynamic)().bootstrapModule(_app_app_module__WEBPACK_IMPORTED_MODULE_2__.AppModule).catch(err => console.log(err));
...
/***/ 91682:
/*!******************************************!*\
  !*** ./src/app/services/boat-routing.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   DEFAULT_ASSET_TYPE: () => (/* binding */ DEFAULT_ASSET_TYPE),
/* harmony export */   DEFAULT_BOAT_ID: () => (/* binding */ DEFAULT_BOAT_ID),
/* harmony export */   SUPPORTED_ASSET_TYPES: () => (/* binding */ SUPPORTED_ASSET_TYPES),
/* harmony export */   activeAssetContext: () => (/* binding */ activeAssetContext),
/* harmony export */   activeAssetType: () => (/* binding */ activeAssetType),
/* harmony export */   activeBoatId: () => (/* binding */ activeBoatId),
/* harmony export */   assetBasePath: () => (/* binding */ assetBasePath),
/* harmony export */   boatPath: () => (/* binding */ boatPath),
/* harmony export */   initializeBoatRouting: () => (/* binding */ initializeBoatRouting),
/* harmony export */   resolveAssetRoute: () => (/* binding */ resolveAssetRoute),
/* harmony export */   validAssetType: () => (/* binding */ validAssetType),
/* harmony export */   validBoatId: () => (/* binding */ validBoatId)
/* harmony export */ });
const DEFAULT_ASSET_TYPE = 'boat';
const DEFAULT_BOAT_ID = 'alegria';
const SUPPORTED_ASSET_TYPES = new Set(['boat', 'place', 'car', 'pool']);
function validAssetType(v) {
  return typeof v === 'string' && SUPPORTED_ASSET_TYPES.has(v.toLowerCase());
}
function validBoatId(v) {
  return typeof v === 'string' && /^[a-z0-9][a-z0-9_-]*$/.test(v);
}
function resolveAssetRoute(pathname) {
  const clean = String(pathname || '/').split('?')[0].split('#')[0],
    p = clean.split('/').filter(Boolean);
  if (p.length >= 2 && validAssetType(p[0]) && validBoatId(p[1])) {
    const c = {
      assetType: p[0].toLowerCase(),
      assetId: p[1].toLowerCase(),
      pathname: clean
    };
    try {
      sessionStorage.setItem('harbornest.assetType', c.assetType);
      sessionStorage.setItem('harbornest.assetId', c.assetId);
    } catch {}
    return c;
  }
  let t = null,
    i = null;
  try {
    t = sessionStorage.getItem('harbornest.assetType');
    i = sessionStorage.getItem('harbornest.assetId');
  } catch {}
  return {
    assetType: validAssetType(t) ? t : DEFAULT_ASSET_TYPE,
    assetId: validBoatId(i) ? i : DEFAULT_BOAT_ID,
    pathname: clean
  };
}
function activeAssetContext() {
  return typeof window === 'undefined' ? {
    ...
    assetId: DEFAULT_BOAT_ID,
    pathname: '/'
  } : resolveAssetRoute(window.location.pathname);
}
function activeBoatId() {
  return activeAssetContext().assetId;
}
function activeAssetType() {
  return activeAssetContext().assetType;
}
function assetBasePath(t = activeAssetType(), i = activeBoatId()) {
  if (!validAssetType(t) || !validBoatId(i)) throw new Error('Invalid resource scope');
  return `/${t}/${i}`;
}
function boatPath(path = '/', id = activeBoatId(), type = activeAssetType()) {
  const clean = `/${String(path || '').replace(/^\/+/, '')}`;
  return `${assetBasePath(type, id)}${clean === '/' ? '' : clean}`;
}
function initializeBoatRouting() {
  if (typeof window !== 'undefined') resolveAssetRoute(window.location.pathname);
}
...
/* harmony import */ var _legacy_route_redirect_legacy_route_redirect_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./legacy-route-redirect/legacy-route-redirect.component */ 19924);
/* harmony import */ var _resource_dashboard_resource_dashboard_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./resource-dashboard/resource-dashboard.component */ 45792);
/* harmony import */ var _resource_list_resource_list_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./resource-list/resource-list.component */ 65416);
...
const routes = [{
  path: '',
  component: _resource_dashboard_resource_dashboard_component__WEBPACK_IMPORTED_MODULE_3__.ResourceDashboardComponent,
  pathMatch: 'full'
},
...
...legacy.map(path => ({
  path,
  component: _legacy_route_redirect_legacy_route_redirect_component__WEBPACK_IMPORTED_MODULE_2__.LegacyRouteRedirectComponent
})), {
  path: 'sorties/:slug',
  component: _legacy_route_redirect_legacy_route_redirect_component__WEBPACK_IMPORTED_MODULE_2__.LegacyRouteRedirectComponent
}, {
...
{
  path: ':assetType',
  component: _resource_list_resource_list_component__WEBPACK_IMPORTED_MODULE_4__.ResourceListComponent,
  pathMatch: 'full'
}, {
