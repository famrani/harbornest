...
const PickerColumn = class {
  constructor(hostRef) {
    ...
    this.initializeScrollListener = () => {
       ...
       */
      const enableHaptics = (0,_ionic_global_b26f573e_js__WEBPACK_IMPORTED_MODULE_5__.a)('ios');
      const {
        el,
        scrollEl
      } = this;
    ...
    this.onKeyDown = ev => {
       ...
       */
      const mobile = (0,_ionic_global_b26f573e_js__WEBPACK_IMPORTED_MODULE_5__.a)('mobile');
      let newOption = null;
      switch (ev.key) {
        case 'ArrowDown':
  ...
  componentWillLoad() {
    ...
    const visibleCallback = entries => {
      ...
      if (ev.isIntersecting) {
         ...
         */
        const oldActive = (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.g)(el).querySelector(`.${PICKER_ITEM_ACTIVE_CLASS}`);
        if (oldActive) {
