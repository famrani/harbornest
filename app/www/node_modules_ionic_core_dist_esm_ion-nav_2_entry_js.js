...
/* harmony import */ var _index_68c0d151_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index-68c0d151.js */ 53101);
/* harmony import */ var _ionic_global_b26f573e_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ionic-global-b26f573e.js */ 23589);
/* harmony import */ var _framework_delegate_56b467ad_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./framework-delegate-56b467ad.js */ 89956);
...
class ViewController {
  ...
  init(container) {
    ...
    return (0,_Users_faycalamrani_data_ADN_boatnest_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if (!_this.element) {
        ...
        _this.element = yield (0,_framework_delegate_56b467ad_js__WEBPACK_IMPORTED_MODULE_7__.a)(_this.delegate, container, component, ['ion-page', 'ion-page-invisible'], _this.params);
      }
    })();
  }
  /**
   ...
   */
  _destroy() {
    (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.n)(this.state !== VIEW_STATE_DESTROYED, 'view state must be ATTACHED');
...
const matches = (view, id, params) => {
  ...
  return (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.s)(view.params, params);
};
...
const Nav = class {
  ...
  componentWillLoad() {
    ...
    if (this.swipeGesture === undefined) {
      ...
      this.swipeGesture = _index_cfd9c1f2_js__WEBPACK_IMPORTED_MODULE_4__.c.getBoolean('swipeBackEnabled', mode === 'ios');
    }
  ...
  componentDidLoad() {
    ...
    return (0,_Users_faycalamrani_data_ADN_boatnest_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.didLoad = true;
      _this2.rootChanged();
      _this2.gesture = (yield __webpack_require__.e(/*! import() */ "common").then(__webpack_require__.bind(__webpack_require__, /*! ./swipe-back-0184f6b3.js */ 6485))).createSwipeBackGesture(_this2.el, _this2.canStart.bind(_this2), _this2.onStart.bind(_this2), _this2.onMove.bind(_this2), _this2.onEnd.bind(_this2));
  ...
  disconnectedCallback() {
    for (const view of this.views) {
      (0,_index_68c0d151_js__WEBPACK_IMPORTED_MODULE_5__.l)(view.element, _index_68c0d151_js__WEBPACK_IMPORTED_MODULE_5__.d);
      view._destroy();
    }
  ...
  prepareTI(ti) {
    ...
    if (ti.removeView !== undefined) {
      (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.n)(ti.removeStart !== undefined, 'removeView needs removeStart');
      (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.n)(ti.removeCount !== undefined, 'removeView needs removeCount');
    ...
    (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.n)(insertViews.length > 0, 'length can not be zero');
  ...
  postViewInit(enteringView, leavingView, ti) {
    var _a, _b, _c;
    (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.n)(leavingView || enteringView, 'Both leavingView and enteringView are null');
    (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.n)(ti.resolve, 'resolve must be valid');
    (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.n)(ti.reject, 'reject must be valid');
    ...
    if (removeStart !== undefined && removeCount !== undefined) {
      (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.n)(removeStart >= 0, 'removeStart can not be negative');
      (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.n)(removeCount >= 0, 'removeCount can not be negative');
      destroyQueue = [];
    ...
    (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.n)(finalNumViews >= 0, 'final balance can not be negative');
    if (finalNumViews === 0) {
      (0,_index_cfd9c1f2_js__WEBPACK_IMPORTED_MODULE_4__.p)(`[ion-nav] - You can't remove all the pages in the navigation stack. nav.pop() is probably called too many times.`, this, this.el);
    ...
    if (destroyQueue && destroyQueue.length > 0) {
      for (const view of destroyQueue) {
        (0,_index_68c0d151_js__WEBPACK_IMPORTED_MODULE_5__.l)(view.element, _index_68c0d151_js__WEBPACK_IMPORTED_MODULE_5__.b);
        (0,_index_68c0d151_js__WEBPACK_IMPORTED_MODULE_5__.l)(view.element, _index_68c0d151_js__WEBPACK_IMPORTED_MODULE_5__.c);
        (0,_index_68c0d151_js__WEBPACK_IMPORTED_MODULE_5__.l)(view.element, _index_68c0d151_js__WEBPACK_IMPORTED_MODULE_5__.d);
      }
  ...
  transition(enteringView, leavingView, ti) {
    ...
    return (0,_Users_faycalamrani_data_ADN_boatnest_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const mode = (0,_ionic_global_b26f573e_js__WEBPACK_IMPORTED_MODULE_6__.b)(_this11);
      ...
      const animationOpts = Object.assign(Object.assign({
        ...
        baseEl: _this11.el,
        progressCallback,
        animated: _this11.animated && _index_cfd9c1f2_js__WEBPACK_IMPORTED_MODULE_4__.c.getBoolean('animated', true),
        enteringEl,
        leavingEl
      }, opts), {
        animationBuilder: opts.animationBuilder || _this11.animation || _index_cfd9c1f2_js__WEBPACK_IMPORTED_MODULE_4__.c.get('navAnimation')
      });
      const {
        hasCompleted
      } = yield (0,_index_68c0d151_js__WEBPACK_IMPORTED_MODULE_5__.t)(animationOpts);
  ...
  insertViewAt(view, index) {
    ...
    if (existingIndex > -1) {
      (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.n)(view.nav === this, 'view is not part of the nav');
      // The view already in the stack, removes it.
      views.splice(existingIndex, 1);
      // and add it back at the requested index.
      views.splice(index, 0, view);
    } else {
      (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.n)(!view.nav, 'nav is used');
   ...
   */
  removeView(view) {
    (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.n)(view.state === VIEW_STATE_ATTACHED || view.state === VIEW_STATE_DESTROYED, 'view state should be loaded or destroyed');
    const views = this.views;
    const index = views.indexOf(view);
    (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.n)(index > -1, 'view must be part of the stack');
    if (index >= 0) {
    ...
    for (let i = views.length - 1; i >= 0; i--) {
      ...
      if (element) {
        if (i > activeViewIndex) {
          ...
          // let's unload it
          (0,_index_68c0d151_js__WEBPACK_IMPORTED_MODULE_5__.l)(element, _index_68c0d151_js__WEBPACK_IMPORTED_MODULE_5__.d);
          this.destroyView(view);
        } else if (i < activeViewIndex) {
          // this view comes before the active view
          // and it is not a portal then ensure it is hidden
          (0,_index_68c0d151_js__WEBPACK_IMPORTED_MODULE_5__.s)(element, true);
        }
      }
    }
  }
