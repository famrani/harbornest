...
export class BoatsComponent implements OnInit, OnDestroy, AfterViewChecked {
  @ViewChild('textInput') textInputInput: any;
  @ViewChild('chatWindow', { static: false }) chatWindowRef: ElementRef;
  public componentName = 'boats.component';
  public loginForm: FormGroup;

  isCollapsed: boolean = true;

  constructor(
    public externalSvc: ExternalService,
  ...
  login() {
    this.externalSvc.localUtilsSvc.processLogin(this.loginForm.value.email, this.loginForm.value.password, undefined).then(
      data => {
