...
export class SeoService {
  ...
  private readonly defaultImage = `${this.origin}/api/media/object?path=${encodeURIComponent('alegria/img/home/home-hero-generic.jpg')}`;
  ...
  update(pathname: string): void {
    ...
    const canonical = `${this.origin}${boatPath(path)}`;
  ...
  private setJsonLd(path: string, url: string, page: SeoPage): void {
    ...
    script.text = JSON.stringify({
      ...
      '@graph': [
        { '@type': 'Organization', '@id': `${this.origin}/#organization`, name: 'Alegria Boat', url: this.origin, logo: `${this.origin}/api/media/object?path=${encodeURIComponent('alegria/img/home/catamaran.png')}` },
