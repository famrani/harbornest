...
export class PhotographersComponent implements OnInit, OnDestroy, AfterViewChecked {
  @ViewChild('textInput') textInputInput: any;
  @ViewChild('chatWindow', { static: false }) chatWindowRef: ElementRef;
  public componentName = 'photographers.component';
  public loginForm: FormGroup;

  isCollapsed: boolean = true;

  constructor(
    public partnersSvc: PartnersService,
  ...
  login() {
    this.partnersSvc.localUtilsSvc.processLogin(this.loginForm.value.email, this.loginForm.value.password, undefined).then(
      data => {
