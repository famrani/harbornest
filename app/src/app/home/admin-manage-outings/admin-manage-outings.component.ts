...
export class AdminManageOutingsComponent implements OnInit, OnDestroy {
  ...
  t(key: string): string {
    const labels: any = {
      fr: { title: 'Gestion des sorties', intro: 'Modifiez les textes, prix, images et langues directement depuis Firebase.', loadError: 'Impossible de charger les sorties.', saveError: 'Impossible de sauvegarder.', saved: 'Sortie sauvegardée.', save: 'Sauvegarder', saving: 'Sauvegarde...', active: 'Active', image: 'Image', price: 'Prix de départ', description: 'Description', duration: 'Durée', guests: 'Passagers', highlights: 'Points forts' },
      en: { title: 'Manage outings', intro: 'Edit texts, prices, images and languages directly from Firebase.', loadError: 'Unable to load outings.', saveError: 'Unable to save.', saved: 'Outing saved.', save: 'Save', saving: 'Saving...', active: 'Active', image: 'Image', price: 'Starting price', description: 'Description', duration: 'Duration', guests: 'Guests', highlights: 'Highlights' },
      es: { title: 'Gestionar salidas', intro: 'Modifique textos, precios, imágenes e idiomas directamente desde Firebase.', loadError: 'No se pueden cargar las salidas.', saveError: 'No se puede guardar.', saved: 'Salida guardada.', save: 'Guardar', saving: 'Guardando...', active: 'Activa', image: 'Imagen', price: 'Precio inicial', description: 'Descripción', duration: 'Duración', guests: 'Pasajeros', highlights: 'Puntos fuertes' },
    };
