...
export const DEFAULT_GUEST_INFO_CONTENT: GuestInfoFirebaseContent = {
  guestFaq: {
    fr: {
      ...
      items: [
        { question: 'Où devons-nous nous présenter ?', answer: 'Le rendez-vous se fait à l’anneau 16, Port Marina Baie des Anges, Villeneuve-Loubet. Nous vous conseillons d’arriver 15 à 20 minutes avant l’heure prévue.' },
    ...
    en: {
      ...
      items: [
        { question: 'Where do we meet?', answer: 'The meeting point is berth 16, Port Marina Baie des Anges, Villeneuve-Loubet. Please arrive 15 to 20 minutes before the scheduled time.' },
    ...
    es: {
      ...
      items: [
        { question: '¿Dónde es el punto de encuentro?', answer: 'El punto de encuentro es el amarre 16, Port Marina Baie des Anges, Villeneuve-Loubet. Recomendamos llegar 15 a 20 minutos antes de la hora prevista.' },
  ...
  guestJourney: {
    fr: {
      ...
      steps: [
        { icon: '📍', title: 'Arrivée au bateau', text: 'Nous vous accueillons directement à l’anneau 16, Port Marina Baie des Anges à Villeneuve-Loubet.', bullets: ['Arrivée conseillée 15 à 20 minutes avant le départ', 'Accueil par l’équipage', 'Premières consignes simples pour monter à bord'] },
        ...
        { icon: '⛵', title: 'Retour vers la marina', text: 'Nous repartons tranquillement vers Marina Baie des Anges en profitant des derniers instants en mer.', bullets: ['Navigation retour', 'Rangement progressif du matériel', 'Arrivée préparée par l’équipage'] },
    ...
    en: {
      ...
      steps: [
        { icon: '📍', title: 'Arrival at the boat', text: 'We welcome you directly at berth 16, Port Marina Baie des Anges in Villeneuve-Loubet.', bullets: ['Arrive 15 to 20 minutes before departure', 'Crew welcome', 'Simple boarding instructions'] },
        ...
        { icon: '⛵', title: 'Return to the marina', text: 'We cruise calmly back to Marina Baie des Anges while enjoying the last moments at sea.', bullets: ['Return cruise', 'Equipment tidying', 'Arrival prepared by the crew'] },
    ...
    es: {
      ...
      steps: [
        { icon: '📍', title: 'Llegada al barco', text: 'Les recibimos directamente en el amarre 16, Port Marina Baie des Anges en Villeneuve-Loubet.', bullets: ['Llegada recomendada 15 a 20 minutos antes', 'Bienvenida de la tripulación', 'Instrucciones sencillas para embarcar'] },
        ...
        { icon: '⛵', title: 'Regreso a la marina', text: 'Volvemos tranquilamente a Marina Baie des Anges disfrutando de los últimos momentos en el mar.', bullets: ['Navegación de regreso', 'Orden del material', 'Llegada preparada por la tripulación'] },
