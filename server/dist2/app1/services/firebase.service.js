...
exports.StoreDbService = exports.USERROLE = exports.OBJECTNAME = void 0;
...
(function (OBJECTNAME) {
    ...
    OBJECTNAME["bnProposals"] = "bnProposals";
    OBJECTNAME["bnFleet"] = "bnFleet";
    OBJECTNAME["bnSkippers"] = "bnSkippers";
    OBJECTNAME["bnOutings"] = "bnOutings";
    OBJECTNAME["bnPricingModel"] = "bnPricingModel";
    ...
    OBJECTNAME["siteContent"] = "siteContent";
...
let StoreDbService = (() => {
    ...
    var StoreDbService = _classThis = class {
        ...
        initFirebase() {
            ...
            const serviceAccount = JSON.parse(fs.readFileSync(currentDir + '/dist2/config/adn-dev-4d05d-firebase-adminsdk-gzmds-f0f734a54c.json', 'utf8'));
            admin.initializeApp({
