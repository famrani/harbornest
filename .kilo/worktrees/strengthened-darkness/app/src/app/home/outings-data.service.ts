...
export class OutingsDataService {
  ...
  private get collectionPath(): string {
    return this.resourceContext.scopedPath(this.collectionName);
  }
  ...
  async saveOuting(outing: DynamicOuting): Promise<void> {
    ...
    const payload = {
      ...outing,
      slug,
      boatId: this.resourceContext.boatId,
  ...
  toTourPage(outing: DynamicOuting | undefined, language: SiteLanguage, fallback: TourPage): TourPage {
    ...
    return {
      ...
      duration: localized.duration || '',
      guests: localized.guests || '',
      price: localized.priceLabel || (outing.priceFrom ? this.priceLabel(language, outing.priceFrom) : ''),
      priceDetails: localized.priceDetails || '',
      highlights: localized.highlights || [],
...
export const DEFAULT_BN_OUTINGS: DynamicOuting[] = [
  {
    ...
    "slug": "journee-en-mer",
    "priceFrom": 1299,
    "image": "/api/media/object?path=boat%2Falegria%2Fimg%2Fevents%2Fcap-antibes%2Fcap-antibes1.jpg",
    "fr": {
  ...
  },
  {
    ...
    "priceFrom": 999,
    "image": "/api/media/object?path=boat%2Falegria%2Fimg%2Fevents%2Fsunset%2Fsunset1.jpg",
    "fr": {
  ...
  },
  {
    ...
    "slug": "party",
    "priceFrom": 999,
    "image": "/api/media/object?path=boat%2Falegria%2Fimg%2Fevents%2Fevjf%2Fevjf-g1.jpg",
    "fr": {
      "title": "Fête privée",
  ...
  },
  {
    ...
    "priceFrom": 999,
    "image": "/api/media/object?path=boat%2Falegria%2Fimg%2Fevents%2Fbusiness-meeting%2Fbusiness-meeting1.jpg",
    "fr": {
