...
/* harmony import */ var _index_9a17db3d_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index-9a17db3d.js */ 29066);
...
function getDecimalPlaces(n) {
  if (!(0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.l)(n)) return 0;
  if (n % 1 === 0) return 0;
...
const Range = class {
  constructor(hostRef) {
    ...
    this.clampBounds = value => {
      return (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.j)(this.min, value, this.max);
    };
    ...
    this.setupGesture = /*#__PURE__*/(0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    this.handleKeyboard = (knob, isIncrease) => {
      ...
      if (knob === 'A') {
        this.ratioA = (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.j)(0, this.ratioA + step, 1);
      } else {
        this.ratioB = (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.j)(0, this.ratioB + step, 1);
      }
  ...
  debounceChanged() {
     ...
     */
    this.ionInput = debounce === undefined ? originalIonInput !== null && originalIonInput !== void 0 ? originalIonInput : ionInput : (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.e)(ionInput, debounce);
  }
  minChanged(newValue) {
    if (!(0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.l)(newValue)) {
      this.min = 0;
    }
    if (!this.noUpdate) {
      this.updateRatio();
  ...
  activeBarStartChanged() {
    ...
    if (activeBarStart !== undefined) {
      if (activeBarStart > this.max) {
        (0,_index_cfd9c1f2_js__WEBPACK_IMPORTED_MODULE_4__.p)(`[ion-range] - The value of activeBarStart (${activeBarStart}) is greater than the max (${this.max}). Valid values are greater than or equal to the min value and less than or equal to the max value.`, this.el);
        this.activeBarStart = this.max;
      } else if (activeBarStart < this.min) {
        (0,_index_cfd9c1f2_js__WEBPACK_IMPORTED_MODULE_4__.p)(`[ion-range] - The value of activeBarStart (${activeBarStart}) is less than the min (${this.min}). Valid values are greater than or equal to the min value and less than or equal to the max value.`, this.el);
  ...
  componentWillLoad() {
    ...
    this.inheritedAttributes = (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.i)(this.el);
    // If min, max, or step are not safe, set them to 0, 100, and 1, respectively.
    // Each watch does this, but not before the initial load.
    this.min = (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.l)(this.min) ? this.min : 0;
    this.max = (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.l)(this.max) ? this.max : 100;
    this.step = (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.l)(this.step) ? this.step : 1;
  }
  componentDidLoad() {
  ...
  connectedCallback() {
    ...
    const ionContent = (0,_index_9a17db3d_js__WEBPACK_IMPORTED_MODULE_2__.f)(this.el);
  ...
  onMove(detail) {
    ...
    if (contentEl && this.pressedKnob === undefined) {
      this.initialContentScrollY = (0,_index_9a17db3d_js__WEBPACK_IMPORTED_MODULE_2__.d)(contentEl);
    }
    /**
  ...
  onEnd(detail) {
     ...
     */
    if (contentEl && this.pressedKnob !== undefined) {
      (0,_index_9a17db3d_js__WEBPACK_IMPORTED_MODULE_2__.r)(contentEl, initialContentScrollY);
    }
  ...
  update(currentX) {
    ...
    let ratio = (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.j)(0, (currentX - rect.left) / rect.width, 1);
  ...
  render() {
    ...
    (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.d)(true, el, this.name, JSON.stringify(this.getValue()), disabled);
...
const ratioToValue = (ratio, min, max, step) => {
  ...
  const clampedValue = (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.j)(min, value, max);
  return roundToMaxDecimalPlaces(clampedValue, min, max, step);
};
const valueToRatio = (value, min, max) => {
  return (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.j)(0, (value - min) / (max - min), 1);
};
let rangeIds = 0;
Range.style = {
