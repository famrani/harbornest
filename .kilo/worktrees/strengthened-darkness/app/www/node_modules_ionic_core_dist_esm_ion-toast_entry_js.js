...
/* harmony import */ var _config_9898ed97_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./config-9898ed97.js */ 47836);
...
/* harmony import */ var _index_cfd9c1f2_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index-cfd9c1f2.js */ 94183);
/* harmony import */ var _overlays_d99dcb0a_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./overlays-d99dcb0a.js */ 27392);
...
/* harmony import */ var _animation_8b25e105_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./animation-8b25e105.js */ 13269);
...
/* harmony import */ var _framework_delegate_56b467ad_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./framework-delegate-56b467ad.js */ 89956);
...
function warnIfAnchorIsHidden(positionAnchor, toast) {
  if (positionAnchor.offsetParent === null) {
    (0,_index_cfd9c1f2_js__WEBPACK_IMPORTED_MODULE_5__.p)('[ion-toast] - The positionAnchor element for ion-toast was found in the DOM, but appears to be hidden. This may lead to unexpected positioning of the toast.', toast);
  }
}
/**
...
const iosEnterAnimation = (baseEl, opts) => {
  ...
  const root = (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.g)(baseEl);
...
const createSwipeToDismissGesture = (el, toastPosition, onDismiss) => {
   ...
   */
  const wrapperEl = (0,_helpers_d94bc8ad_js__WEBPACK_IMPORTED_MODULE_3__.g)(el).querySelector('.toast-wrapper');
  ...
  const swipeAnimation = (0,_animation_8b25e105_js__WEBPACK_IMPORTED_MODULE_9__.c)('toast-swipe-to-dismiss-animation').addElement(wrapperEl)
  /**
  ...
  const gesture = (0,_index_39782642_js__WEBPACK_IMPORTED_MODULE_11__.createGesture)({
    ...
    gesturePriority: _overlays_d99dcb0a_js__WEBPACK_IMPORTED_MODULE_6__.O,
    /**
...
const Toast = class {
  constructor(hostRef) {
    ...
    this.delegateController = (0,_overlays_d99dcb0a_js__WEBPACK_IMPORTED_MODULE_6__.d)(this);
    this.lockController = (0,_lock_controller_316928be_js__WEBPACK_IMPORTED_MODULE_4__.c)();
    this.triggerController = (0,_overlays_d99dcb0a_js__WEBPACK_IMPORTED_MODULE_6__.e)();
    this.customHTMLEnabled = _index_cfd9c1f2_js__WEBPACK_IMPORTED_MODULE_5__.c.get('innerHTMLTemplatesEnabled', _config_9898ed97_js__WEBPACK_IMPORTED_MODULE_2__.E);
    this.presented = false;
    this.dispatchCancelHandler = ev => {
      const role = ev.detail.role;
      if ((0,_overlays_d99dcb0a_js__WEBPACK_IMPORTED_MODULE_6__.i)(role)) {
    ...
    this.createSwipeGesture = toastPosition => {
      const gesture = this.gesture = createSwipeToDismissGesture(this.el, toastPosition, () => {
         ...
         */
        this.dismiss(undefined, _overlays_d99dcb0a_js__WEBPACK_IMPORTED_MODULE_6__.G);
      });
      gesture.enable(true);
    };
    /**
    ...
    this.duration = _index_cfd9c1f2_js__WEBPACK_IMPORTED_MODULE_5__.c.getNumber('toastDuration', 0);
  ...
  connectedCallback() {
    (0,_overlays_d99dcb0a_js__WEBPACK_IMPORTED_MODULE_6__.j)(this.el);
    this.triggerChanged();
  }
  ...
  componentWillLoad() {
    ...
    if (!((_a = this.htmlAttributes) === null || _a === void 0 ? void 0 : _a.id)) {
      (0,_overlays_d99dcb0a_js__WEBPACK_IMPORTED_MODULE_6__.k)(this.el);
    }
  }
  componentDidLoad() {
    /**
  ...
  present() {
    ...
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const animationPosition = getAnimationPosition(position, anchor, (0,_ionic_global_b26f573e_js__WEBPACK_IMPORTED_MODULE_8__.b)(_this), el);
      /**
      ...
      yield (0,_overlays_d99dcb0a_js__WEBPACK_IMPORTED_MODULE_6__.f)(_this, 'toastEnter', iosEnterAnimation, mdEnterAnimation, {
        position,
  ...
  dismiss(data, role) {
    ...
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const dismissed = yield (0,_overlays_d99dcb0a_js__WEBPACK_IMPORTED_MODULE_6__.g)(_this2, data, role, 'toastLeave', iosLeaveAnimation, mdLeaveAnimation,
      /**
   ...
   */
  onDidDismiss() {
    return (0,_overlays_d99dcb0a_js__WEBPACK_IMPORTED_MODULE_6__.h)(this.el, 'ionToastDidDismiss');
  }
  /**
   * Returns a promise that resolves when the toast will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_d99dcb0a_js__WEBPACK_IMPORTED_MODULE_6__.h)(this.el, 'ionToastWillDismiss');
  }
  getButtons() {
  ...
  getAnchorElement() {
    ...
    if (position === 'middle' && positionAnchor !== undefined) {
      (0,_index_cfd9c1f2_js__WEBPACK_IMPORTED_MODULE_5__.p)('[ion-toast] - The positionAnchor property is ignored when using position="middle".', this.el);
      return undefined;
    }
    if (typeof positionAnchor === 'string') {
      ...
      if (foundEl === null) {
        (0,_index_cfd9c1f2_js__WEBPACK_IMPORTED_MODULE_5__.p)(`[ion-toast] - An anchor element with an ID of "${positionAnchor}" was not found in the DOM.`, el);
        return undefined;
      }
      return foundEl;
    }
    ...
    (0,_index_cfd9c1f2_js__WEBPACK_IMPORTED_MODULE_5__.p)('[ion-toast] - Invalid positionAnchor value:', positionAnchor, el);
    return undefined;
  }
  buttonClick(button) {
    var _this3 = this;
  ...
  callButtonHandler(button) {
    return (0,_Users_faycalamrani_data_ADN_harbornest_1_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (button === null || button === void 0 ? void 0 : button.handler) {
        ...
        try {
          const rtn = yield (0,_overlays_d99dcb0a_js__WEBPACK_IMPORTED_MODULE_6__.s)(button.handler);
          if (rtn === false) {
            // if the return value of the handler is false then do not dismiss
            return false;
          }
        } catch (e) {
          (0,_index_cfd9c1f2_js__WEBPACK_IMPORTED_MODULE_5__.d)('[ion-toast] - Exception in callButtonHandler:', e);
        }
      }
      return true;
    })();
  ...
  render() {
    ...
    if (layout === 'stacked' && startButtons.length > 0 && endButtons.length > 0) {
      (0,_index_cfd9c1f2_js__WEBPACK_IMPORTED_MODULE_5__.p)('[ion-toast] - This toast is using start and end buttons with the stacked toast layout. We recommend following the best practice of using either start or end buttons with the stacked toast layout.', el);
    }
...
const buttonPart = button => {
  return (0,_overlays_d99dcb0a_js__WEBPACK_IMPORTED_MODULE_6__.i)(button.role) ? 'button cancel' : 'button';
};
Toast.style = {
